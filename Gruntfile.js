// Generated on 2015-11-11 using generator-angular-fullstack 3.0.0-rc8
'use strict';
        ...
        copy: {
            dist: {
                files: [{
                    ...
                    // include material-design-iconic-font webfonts
                    //
                    expand: true,
                    dot: true,
                    ...
                    // include weather-icons webfonts
                    //
                    expand: true,
                    dot: true,
                    cwd: '<%= yeoman.client %>/bower_components/weather-icons',
                    src: ['fonts/*.*'],
                    dest: '<%= yeoman.dist %>/client/assets'
                }]
            },
